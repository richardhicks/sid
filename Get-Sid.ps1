...
.LINK
    https://github.com/richardhicks/sid/blob/main/Get-Sid.ps1
...
Switch ($Machine) {
    ...
    $True  {
        ...
        If ($IsDomainJoined) {
            ...
            # Domain-joined machine SID retrieval
            ...
            Catch {
                ...
                Write-Warning "Unable to translate machine $Principal to SID."
        ...
        Else {
            ...
            # Non-domain joined machine SID retrieval
            Try {

                $Sid = ((Get-LocalUser -Name $env:USERNAME).SID.Value -replace '-\d+$','')
                $Principal = "$env:COMPUTERNAME"
            ...
            Catch {
                ...
                Write-Warning "Unable to retrieve local machine SID."
                Write-Warning $_.Exception.Message
                Return
    ...
    Default {
        ...
        Catch {
            ...
            Write-Warning "Unable to translate user $Principal to SID."
            Write-Warning $_.Exception.Message
            Return
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDG9Wuv/6KKr0iu
# oKV757lFRt0RzQDVbwU10j0O3U6e96CCGmIwggNZMIIC36ADAgECAhAPuKdAuRWN
...
# AYI3AgEVMC8GCSqGSIb3DQEJBDEiBCAUHblrVXXjJSv1oJFUALcs2ycTwC5dQItO
# 019ehVLogjALBgcqhkjOPQIBBQAERzBFAiBM2f3VkUIrY5gc9lF1k/6LLRI5C57Z
# m2OxiP5YVt1YFwIhAO1QGm71p4rgN/lWEHkeilQopZzAc0R5qemPiCWH9bFkoYID
...
# HAYJKoZIhvcNAQkFMQ8XDTI1MDQyNzAyNDcyNlowLwYJKoZIhvcNAQkEMSIEIOTE
# OtNGtdx7hwv/xB5NXjwufeRGRAFkBSGzJG5obNzJMA0GCSqGSIb3DQEBAQUABIIC
# AE2IHoej2D2unDLA3wtEo5Kz09ZcP7ZkP0DbAPPRJOMo5mXrm4+I795SRFwKOf57
# SFGzHlDstlPIg+rGmW5V6+5YH7uPr8yaBisM/sc4z5/wVtB3HLHZ4fseGvEXtPjh
# /5RgfIV6iPhLmTA0JgpzewoQzbYF0S8KT46ySnn5NtbWnH3mQS6YotlsruHpmZ1j
# oS1/UtYDvDHh6HVha/LBB1eQePwGxBUw+e5mn61qUWGW73Ue6O1YUcATSvUNQTUY
# TUA3MMgGDcdlVd+4Hol+jvKza5b6T/nyFgaTbC3sDP8Gbpz5XGHyg8sMMf1aN2wf
# UHCrR9TnbrFeX1ftO9RX/dlpstMVqlxxljuy1fb3hJlSSWDm640qnodQTzetNwd5
# E62HQfjoJLGCeASRsquOnj9C7QovBVxrQgalbguMmXwQsUeHXUWvX3UUFGC/UG1z
# F2IStCRgFsesbBkACsLVlCqnDpIc6B2MLZUxTi5iBa7x8iZk9HBavfn3r3zcg1e0
# a1g4JVF1eDrGFWkPri58DhlATSe1lVTfgmGkTmnk+HyvOFooeNkpgrwdlWe5k1pM
# u+QQv78NOtc8Inn7Ky8bBwt8JIXGJIS637AIFqN9uFU4j3KOzdq646MEdgPw7Ol7
# KOrq11Nue3p/AtySfOZSnVPIYxtSSaaYmj+ZjF2+ReJX
